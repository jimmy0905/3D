...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Zn,depthTest:!1,depthWrite:!1})}function eu(){return new wi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ul(),fragmentShader:`
		...
		`,blending:Zn,depthTest:!1,depthWrite:!1})}function tu(){return new wi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ul(),fragmentShader:`
